...
(def borrowevent-schema-dsl "Define our data structure." {"book" {"title" "string"
                                                                  "author" "string"} "borrower" {"name" "string"} "date" "string"})
...
(def trans-result
  "Add the schema to the database. Save the result in a symbol if we need tolook at it."
