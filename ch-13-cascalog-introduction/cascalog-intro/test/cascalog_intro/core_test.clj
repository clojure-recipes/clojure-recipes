(ns cascalog-intro.core-test (:require [clojure.test :refer :all]
                                       [cascalog-intro.core :refer :all] [cascalog.api :refer :all] [cascalog.logic [ops :as c]]))
(def prices
  [;; [stock-symbol price]
